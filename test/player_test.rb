...
class PlayerTest < Minitest::Test
  def test_it_can_place_ships
    player1 = Player.new
    player2 = Player.new
    player2.board = player1.place_ship("a1","a2", 2, player2.board)
  ...
  def placed_ships_cannot_cross
    ...
    player2 = Player.new
    player2.board = player1.place_ship("a1","a2", 2, player2.board)
    player2.board = player1.place_ship("a1", "b1", 2, player2.board)
    assert_equal 1, player1.ships.count
  end
  ...
  def test_players_know_if_a_ship_exists_at_location
    player1 = Player.new
    player2 = Player.new
    player1.place_ship("a1","a2",2, player2.board)
    target_location = "a1"
    ship = player1.find_ship(target_location)
